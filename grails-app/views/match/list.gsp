                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <g:sortableColumn property="lastUpdated" title="${message(code: 'match.lastUpdated.label', default: 'Last Updated')}" />
                    ...
                    <g:each in="${matchInstanceList}" status="i" var="matchInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td><g:formatDate date="${matchInstance.lastUpdated}" /></td>
