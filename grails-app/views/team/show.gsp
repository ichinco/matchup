            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="team.captain.label" default="Captain" /></td>
                            
                            <td valign="top" class="value"><g:link controller="user" action="show" id="${teamInstance?.captain?.id}">${teamInstance?.captain?.encodeAsHTML()}</g:link></td>
