                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="captain"><g:message code="team.captain.label" default="Captain" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: teamInstance, field: 'captain', 'errors')}">
                                    <g:select name="captain.id" from="${com.matchup.User.list()}" optionKey="id" value="${teamInstance?.captain?.id}"  />
                                </td>
                            </tr>
